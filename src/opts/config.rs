...
impl FromStr for Position {
    ...
    fn from_str(input: &str) -> Result<Self, Self::Err> {
        ...
        let x = parts[0].parse::<i32>().map_err(|_| "Invalid x-coordinate: not a valid integer")?;
        let y = parts[1].parse::<i32>().map_err(|_| "Invalid y-coordinate: not a valid integer")?;
        Ok(Position { x, y })
    }
}
...
impl FromStr for Size {
    ...
    fn from_str(input: &str) -> Result<Self, Self::Err> {
        ...
        let width = parts[0].parse::<u32>().map_err(|_| "Invalid width: not a valid integer")?;
        let height = parts[1].parse::<u32>().map_err(|_| "Invalid height: not a valid integer")?;
